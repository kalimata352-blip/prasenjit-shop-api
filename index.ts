...
// QUIZ: 6 subjects × 10 Q × 10 marks = 600 total. Pass >= 210. Only approved, one attempt.
const QUIZ_QUESTIONS = [
  // বাংলা (10)
  {s:"বাংলা",k:"bengali",q:"রবীন্দ্রনাথ ঠাকুরের জন্ম কোন সালে?",o:["১৮৬১","১৮৭০","১৮৫০","১৮৮০"],a:0},
  {s:"বাংলা",k:"bengali",q:"'গীতাঞ্জলি' কার লেখা?",o:["রবীন্দ্রনাথ ঠাকুর","বঙ্কিমচন্দ্র","নজরুল","শরৎচন্দ্র"],a:0},
  {s:"বাংলা",k:"bengali",q:"বাংলা সাহিত্যের প্রথম উপন্যাস কোনটি?",o:["দুর্গেশনন্দিনী","কপালকুণ্ডলা","আনন্দমঠ","চোখের বালি"],a:0},
  {s:"বাংলা",k:"bengali",q:"কাজী নজরুল ইসলামের উপাধি কী?",o:["বিদ্রোহী কবি","রবীন্দ্রকবি","গীতিকবি","নাট্যকার"],a:0},
  {s:"বাংলা",k:"bengali",q:"'আমার সোনার বাংলা' কে রচনা করেন?",o:["রবীন্দ্রনাথ ঠাকুর","নজরুল","দ্বিজেন্দ্রলাল","অতুলপ্রসাদ"],a:0},
  {s:"বাংলা",k:"bengali",q:"বঙ্কিমচন্দ্র চট্টোপাধ্যায়ের বিখ্যাত উপন্যাস?",o:["আনন্দমঠ","পথের পাঁচালী","পদ্মানদীর মাঝি","হাজার চুরাশির মা"],a:0},
  {s:"বাংলা",k:"bengali",q:"বাংলা ভাষার বর্ণমালায় স্বরবর্ণ কয়টি?",o:["১১","১০","১২","১৪"],a:0},
  {s:"বাংলা",k:"bengali",q:"'পথের পাঁচালী' কার লেখা?",o:["বিভূতিভূষণ বন্দ্যোপাধ্যায়","শরৎচন্দ্র","তারাশঙ্কর","মানিক"],a:0},
  {s:"বাংলা",k:"bengali",q:"নজরুলের বিখ্যাত কবিতা?",o:["বিদ্রোহী","সোনার তরী","নির্ঝরের স্বপ্নভঙ্গ","চিত্রা"],a:0},
  {s:"বাংলা",k:"bengali",q:"বাংলা নববর্ষ কবে?",o:["১৪ এপ্রিল","১৫ আগস্ট","২৬ জানুয়ারি","২১ ফেব্রুয়ারি"],a:0},
  // ইংরেজি (10)
  {s:"ইংরেজি",k:"english",q:"Synonym of 'Happy'?",o:["Joyful","Sad","Angry","Tired"],a:0},
  {s:"ইংরেজি",k:"english",q:"Antonym of 'Big'?",o:["Small","Large","Huge","Tall"],a:0},
  {s:"ইংরেজি",k:"english",q:"'She ___ to school every day.'",o:["goes","go","going","gone"],a:0},
  {s:"ইংরেজি",k:"english",q:"Plural of 'Child'?",o:["Children","Childs","Childes","Childrens"],a:0},
  {s:"ইংরেজি",k:"english",q:"Past tense of 'Go'?",o:["Went","Gone","Going","Goes"],a:0},
  {s:"ইংরেজি",k:"english",q:"'I have ___ a book.'",o:["read","reads","reading","to read"],a:0},
  {s:"ইংরেজি",k:"english",q:"Capital of England?",o:["London","Paris","Berlin","Rome"],a:0},
  {s:"ইংরেজি",k:"english",q:"Opposite of 'Hot'?",o:["Cold","Warm","Cool","Heat"],a:0},
  {s:"ইংরেজি",k:"english",q:"'The sun ___ in the east.'",o:["rises","rise","rising","rose"],a:0},
  {s:"ইংরেজি",k:"english",q:"How many letters in English alphabet?",o:["26","24","28","30"],a:0},
  // ইতিহাস (10)
  {s:"ইতিহাস",k:"history",q:"ভারতের স্বাধীনতা দিবস কবে?",o:["১৫ আগস্ট ১৯৪৭","২৬ জানুয়ারি ১৯৫০","২ অক্টোবর ১৯৪৭","১৪ আগস্ট ১৯৪৭"],a:0},
  {s:"ইতিহাস",k:"history",q:"মহাত্মা গান্ধী কোথায় জন্মগ্রহণ করেন?",o:["পোরবন্দার","আহমেদাবাদ","দিল্লি","মুম্বাই"],a:0},
  {s:"ইতিহাস",k:"history",q:"ভারতের প্রথম প্রধানমন্ত্রী কে?",o:["জওহরলাল নেহেরু","সরদার প্যাটেল","গান্ধী","রাজেন্দ্র প্রসাদ"],a:0},
  {s:"ইতিহাস",k:"history",q:"ভারতের সংবিধান কবে কার্যকর?",o:["২৬ জানুয়ারি ১৯৫০","১৫ আগস্ট ১৯৪৭","২৬ নভেম্বর ১৯৪৯","২৬ জানুয়ারি ১৯৪৯"],a:0},
  {s:"ইতিহাস",k:"history",q:"চাণক্য কোন রাজার মন্ত্রী?",o:["চন্দ্রগুপ্ত মৌর্য","অশোক","হর্ষবর্ধন","আকবর"],a:0},
  {s:"ইতিহাস",k:"history",q:"তাজমহল কে নির্মাণ করেন?",o:["শাহজাহান","আকবর","বাবর","আওরঙ্গজেব"],a:0},
  {s:"ইতিহাস",k:"history",q:"জাতীয় পতাকা কে ডিজাইন করেন?",o:["পিঙ্গলি ভেঙ্কাইয়া","গান্ধী","নেহেরু","সুভাষ"],a:0},
  {s:"ইতিহাস",k:"history",q:"ভারত ছাড়ো আন্দোলন কবে?",o:["১৯৪২","১৯৪৭","১৯৩০","১৯১৯"],a:0},
  {s:"ইতিহাস",k:"history",q:"জলियाँওয়ালাবাগ হত্যাকাণ্ড কোন সালে?",o:["১৯১৯","১৯২০","১৯১৮","১৯২২"],a:0},
  {s:"ইতিহাস",k:"history",q:"সুভাষ চন্দ্র বসুর উপাধি?",o:["নেতাজি","মহামান্য","বাপু","পণ্ডিত"],a:0},
  // ভূগোল (10)
  {s:"ভূগোল",k:"geography",q:"ভারতের দীর্ঘতম নদী?",o:["গঙ্গা","ব্রহ্মপুত্র","যমুনা","গোদাবরী"],a:0},
  {s:"ভূগোল",k:"geography",q:"ভারতের সর্বোচ্চ পর্বত?",o:["কাঞ্চনজঙ্ঘা","এভারেস্ট","নন্দাদেবী","অন্নপূর্ণা"],a:0},
  {s:"ভূগোল",k:"geography",q:"ভারতের রাজধানী?",o:["নয়াদিল্লি","মুম্বাই","কলকাতা","চেন্নাই"],a:0},
  {s:"ভূগোল",k:"geography",q:"থার মরুভূমি কোন রাজ্যে?",o:["রাজস্থান","গুজরাট","পাঞ্জাব","হরিয়ানা"],a:0},
  {s:"ভূগোল",k:"geography",q:"ভারতের দক্ষিণতম বিন্দু?",o:["কন্যাকুমারী","ইন্দিরা পয়েন্ট","চেন্নাই","কোচি"],a:1},
  {s:"ভূগোল",k:"geography",q:"সুন্দরবন কোন রাজ্যে?",o:["পশ্চিমবঙ্গ","ওড়িশা","অসম","বিহার"],a:0},
  {s:"ভূগোল",k:"geography",q:"ক্ষেত্রফলে সবচেয়ে বড় রাজ্য?",o:["রাজস্থান","মধ্যপ্রদেশ","মহারাষ্ট্র","উত্তরপ্রদেশ"],a:0},
  {s:"ভূগোল",k:"geography",q:"ভারতের পূর্বতম রাজ্য?",o:["অরুণাচল প্রদেশ","অসম","মণিপুর","মিজোরাম"],a:0},
  {s:"ভূগোল",k:"geography",q:"হIMALAYAS কোন দিকে?",o:["উত্তর","দক্ষিণ","পূর্ব","পশ্চিম"],a:0},
  {s:"ভূগোল",k:"geography",q:"ভারত মহাসাগর কোন দিকে?",o:["দক্ষিণ","উত্তর","পূর্ব","পশ্চিম"],a:0},
  // অংক (10)
  {s:"অংক",k:"math",q:"২৫ + ৩৭ = ?",o:["৬২","৬০","৬৪","৫৮"],a:0},
  {s:"অংক",k:"math",q:"১২ × ৮ = ?",o:["৯৬","৮৪","১০৮","৮৮"],a:0},
  {s:"অংক",k:"math",q:"১০০ ÷ ৫ = ?",o:["২০","২৫","১৫","৩০"],a:0},
  {s:"অংক",k:"math",q:"ত্রিভুজের কোণের যোগফল?",o:["১৮০°","৯০°","৩৬০°","২৭০°"],a:0},
  {s:"অংক",k:"math",q:"১০% of ২০০ = ?",o:["২০","২৫","১৫","৩০"],a:0},
  {s:"অংক",k:"math",q:"ব্যাসার্ধ ৭ হলে ব্যাস?",o:["১৪","৭","২১","২৮"],a:0},
  {s:"অংক",k:"math",q:"৫² = ?",o:["২৫","১০","১৫","২০"],a:0},
  {s:"অংক",k:"math",q:"৭ × ৯ = ?",o:["৬৩","৫৬","৭২","৬৪"],a:0},
  {s:"অংক",k:"math",q:"৫০% of ৮০ = ?",o:["৪০","৩০","৫০","২০"],a:0},
  {s:"অংক",k:"math",q:"১৫ − ৮ = ?",o:["৭","৬","৮","৯"],a:0},
  // GK (10)
  {s:"GK",k:"gk",q:"ভারতের জাতীয় পশু?",o:["বাঘ","সিংহ","হাতি","ময়ূর"],a:0},
  {s:"GK",k:"gk",q:"ভারতের জাতীয় পাখি?",o:["ময়ূর","কাক","শকুন","হাঁস"],a:0},
  {s:"GK",k:"gk",q:"ভারতের জাতীয় ফল?",o:["আম","কলা","আপেল","কমলা"],a:0},
  {s:"GK",k:"gk",q:"ভারতের মুদ্রা?",o:["রুপি","ডলার","ইউরো","পাউন্ড"],a:0},
  {s:"GK",k:"gk",q:"বর্তমান রাষ্ট্রপতি (২০২৪+)?",o:["দ্রৌপদী মুর্মু","রামনাথ কোবিন্দ","প্রণব মুখোপাধ্যায়","প্রতিভা পাটিল"],a:0},
  {s:"GK",k:"gk",q:"ক্রিকেট বিশ্বকাপ কত বছর অন্তর?",o:["৪ বছর","২ বছর","৫ বছর","৩ বছর"],a:0},
  {s:"GK",k:"gk",q:"জাতীয় সংগীত কে রচনা করেন?",o:["রবীন্দ্রনাথ ঠাকুর","বঙ্কিমচন্দ্র","গান্ধী","নেহেরু"],a:0},
  {s:"GK",k:"gk",q:"ভারতের জাতীয় খেলা?",o:["হকি","ক্রিকেট","ফুটবল","কাবাডি"],a:0},
  {s:"GK",k:"gk",q:"জাতীয় পুষ্প?",o:["পদ্ম","গোলাপ","গাঁদা","জবা"],a:0},
  {s:"GK",k:"gk",q:"জাতীয় বৃক্ষ?",o:["বট","আম","পাইন","দেবদারু"],a:0}
];
...
async function saveExam(){
  if(!ADMIN_TOKEN){ alert('আগে Admin Token দিন ও Save করুন'); return; }
  calcTotal();
  const data={
  ...
  try{
    ...
    document.getElementById('examMsg').innerHTML='❌ Network/Server Error: '+err.message;
  }
}
...
export default {
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    // ========== QUIZ APIs ==========
    // Check if volunteer can take quiz (approved + no prior attempt)
    if (url.pathname.startsWith("/api/quiz/check/") && req.method === "GET") {
      ...
      if (!vol) return Response.json({ success: false, message: "ID পাওয়া যায়নি। সঠিক Volunteer ID দিন।" }, { headers });
      if (vol.status !== "approved") {
        return Response.json({ success: false, message: "আপনি এখনো Approved নন। Admin Approve করলে তবেই পরীক্ষা দিতে পারবেন। বর্তমান স্ট্যাটাস: " + vol.status }, { headers });
      }
      const attempt: any = await env.DB.prepare("SELECT * FROM quiz_attempts WHERE volunteer_id = ?").bind(vol.id).first();
      if (attempt) {
        return Response.json({ success: false, message: "আপনি ইতিমধ্যে উত্তরপত্র জমা দিয়েছেন। একবারই সুযোগ। স্কোর: " + attempt.total_score + "/600 | Result পেজে দেখুন।" }, { headers });
      }
    ...
    if (url.pathname === "/api/quiz/submit" && req.method === "POST") {
      try {
        const d: any = await req.json();
        if (!d.volunteer_id) return Response.json({ success: false, message: "volunteer_id লাগবে" }, { headers });
        // Double-check no prior attempt
        const exist: any = await env.DB.prepare("SELECT * FROM quiz_attempts WHERE volunteer_id = ?").bind(d.volunteer_id).first();
        if (exist) return Response.json({ success: false, message: "ইতিমধ্যে জমা দেওয়া হয়েছে। দ্বিতীয়বার নেওয়া যাবে না।" }, { headers });
