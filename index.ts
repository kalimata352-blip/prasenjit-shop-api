  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    try {
      await env.DB.prepare(`CREATE TABLE IF NOT EXISTS volunteers (
        id TEXT PRIMARY KEY, name TEXT, father_name TEXT, dob TEXT, mobile TEXT, whatsapp TEXT,
        voter_card TEXT UNIQUE, district TEXT, address TEXT, qualification TEXT, experience TEXT,
      ...
      // exam_results now stores marks (numbers) + grades
      await env.DB.prepare(`CREATE TABLE IF NOT EXISTS exam_results (
        volunteer_id TEXT PRIMARY KEY, name TEXT, phone TEXT,
        bengali REAL, english REAL, history REAL, geography REAL, math REAL, gk REAL,
        bengali_grade TEXT, english_grade TEXT, history_grade TEXT, geography_grade TEXT, math_grade TEXT, gk_grade TEXT,
        total_grade TEXT, created_at DATETIME DEFAULT CURRENT_TIMESTAMP
      )`).run();
    } catch (e) {}
